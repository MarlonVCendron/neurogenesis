...
\multirow[t]{7}{*}{$\vcenter{\hbox{\includegraphics[height=1.5em]{mgc.png}}}$ Mature granule}
...
$\vcenter{\hbox{\includegraphics[height=1.5em]{igc.png}}}$ Immature granule
...
\multirow[t]{4}{*}{$\vcenter{\hbox{\includegraphics[height=1.5em]{mc.png}}}$ Mossy}
...
$\vcenter{\hbox{\includegraphics[height=1.5em]{hipp.png}}}$ HIPP
  & n/a                                     &
  & 6.38
  &                                         &
  & 100\% \\
...
\multirow[t]{2}{*}{$\vcenter{\hbox{\includegraphics[height=1.5em]{bc.png}}}$ Basket}
...
\multirow[t]{7}{*}{$\vcenter{\hbox{\includegraphics[height=1.5em]{pca3.png}}}$ CA3 pyramidal}
...
\multirow[t]{3}{*}{$\vcenter{\hbox{\includegraphics[height=1.5em]{ica3.png}}}$ CA3 inhibitory}
...
\caption{%
  ...
  \textit{In vivo} firing rates are mean $\pm$ SD\@. \textsuperscript{max} maximum observed rate. $\approx$ approximate value read
  from figure. Model firing rates are the mean over active cells and model activation the fraction of active cells; both are from
