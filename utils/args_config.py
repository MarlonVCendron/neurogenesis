...
parser.add_argument("--igc-conn", type=float, default=0.5, help="IGC connectivity fraction (between 0 and 1)")
...
parser.add_argument("--n-bc", type=int, default=60, help="Number of BC neurons")
parser.add_argument("--n-mc", type=int, default=100, help="Number of MC neurons")
parser.add_argument("--n-hipp", type=int, default=60, help="Number of HIPP neurons")
